...
<div id="wrapper">
    ...
    <div class="modal fade" id="terms-and-conditions-modal" tabindex="-1" role="dialog" aria-labelledby="termsAndConditionModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="login-modal-close-button">
                ...
                <div class="modal-header login-modal-header-area">
                    <h5 class="modal-title login-modal-title" id="termsAndConditionModalLabel">Terms and Conditions</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            <div class="article" id="content">
                                <div id="placeholders">
                                    ...
                                    <p>Welcome to <span class="highlight preview_website_name">E Ticket Online Platform</span>!</p>
                                    ...
                                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use <span
                                                class="highlight preview_website_name">Website Name</span> if you do not agree to take all of the
                                    ...
                                    <p>We employ the use of cookies. By accessing <span class="highlight preview_website_name">Website Name</span>,
                                        you agreed to use cookies in agreement with the <span
                                                class="highlight preview_company_name">Company Name</span>'s Privacy Policy.</p>
                                    ...
                                    <p>Unless otherwise stated, <span class="highlight preview_company_name">Company Name</span> and/or its licensors
                                        own the intellectual property rights for all material on <span class="highlight preview_website_name">Website Name</span>.
                                    ...
                                    <ul>
                                        ...
                                        <li>Reproduce, duplicate or copy material from <span
                                                    class="highlight preview_website_name">Website Name</span></li>
                                    ...
                                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                                        ...
                                        permitted by applicable laws, <span class="highlight preview_company_name">Company Name</span> shall not be
                                    ...
                                    <p>You hereby grant <span class="highlight preview_company_name">Company Name</span> a non-exclusive license to
                                        use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all
                                    ...
                                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                                        ...
                                        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of <span
                                                class="highlight preview_company_name">Company Name</span>; and (d) the link is in the context of
                                    ...
                                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                                        you must inform us by sending an e-mail to <span class="highlight preview_company_name">Company Name</span>.
                                        Please include your name, your organization name, contact information as well as the URL of your site, a list
                                        of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you
