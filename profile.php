                ...
                <div class="ui-sec-container shadowCustomMid">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-danger px-4 mr-4 py-2 h-100 rounded-lg">
                            <h4 class="m-0 px-4 " data-toggle="modal" data-target="#add-complaint-modal"><b>Add</b></h4>
                        </button>
                    </div>
                </div>
                <div class="ui-sec-container shadowCustomMid">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-success px-4 mr-4 py-2 h-100 rounded-lg">
                            <h4 class="m-0 px-4 " data-toggle="modal" data-target="#view-complaint-modal"><b>View</b></h4>
                        </button>
                    </div>
                </div>
                <div class="ui-sec-container shadowCustomMid">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-success px-4 mr-4 py-2 h-100 rounded-lg">
                            <h4 class="m-0 px-4 " data-toggle="modal" data-target="#resolved-complaint-modal"><b>View</b></h4>
                        </button>
                    </div>
                </div>
            </div>
...
<!-- Complaint Add Modal -->
<div class="modal fade" id="add-complaint-modal" tabindex="-1" role="dialog"
     aria-labelledby="addComplaintLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Complaint Add</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="complaint_title" id="complaint_title" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="complaint_details">Complaint Details</label>
                            <textarea name="complaint_details" class="form-control" id="complaint_details" cols="30" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <button class="btn btn-info px-4 py-2" data-dismiss="modal">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="view-complaint-modal" tabindex="-1" role="dialog"
     aria-labelledby="viewComplaintLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Complaint Status View</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h3>Food Quality</h3>
                                <span class="badge badge-warning" style="height: 20px;">Pending</span>
                            </div>
                            <div class="card-body">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam, aspernatur consequuntur dolore
                                    doloremque doloribus ducimus excepturi hic ipsum, nesciunt nostrum nulla odio, perferendis qui quo ratione
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h3>Ticket Receiving Harrassment</h3>
                                <span class="badge badge-warning" style="height: 20px;">Pending</span>
                            </div>
                            <div class="card-body">
                                <p>
...
<div class="modal fade" id="resolved-complaint-modal" tabindex="-1" role="dialog"
     aria-labelledby="resolvedComplaintLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resolvedComplaintLabel">Resolved Complaint</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h3>Seat Comfortness</h3>
                                <span class="badge badge-success" style="height: 20px;">Solved</span>
                            </div>
                            <div class="card-body">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam, aspernatur consequuntur dolore
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h3>Online Ticket Purchasing</h3>
                                <span class="badge badge-success" style="height: 20px;">Solved</span>
                            </div>
                            <div class="card-body">
                                <p>
